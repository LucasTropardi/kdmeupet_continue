      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Google Analytics</h1>           
          </div>
          ...
          <div class="table-responsive">
            ...
            <div align="center"><a href="https://analytics.google.com/analytics/web/" target="_blank">
                    <button type="submit" class="btn btn-secondary">Google Analytics - ACESSO</button>
            </a></div>
