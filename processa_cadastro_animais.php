<?php
  ...
  $query = "INSERT INTO `cadastro_animal` (`c_nomeanimal`, `c_foto`, `c_descricao`, `c_usuario`, `c_raca`, `c_tamanho`, `c_data`, 
  `c_finalizado`, `id_cor`, `c_situacao`,  `c_contato`,  `c_latitude` ,  `c_longitude`) VALUES ('$nome' , '$foto' , '$descricao' , $usuario , 
  $raca , $tamanho , '$data' , $finalizado , $cor , $situacao, '$contato', '$latitude', '$longitude')";
